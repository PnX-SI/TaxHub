...
user_pg_pass=${POSTGRES_PASSWORD:-monpassachanger}
echo "user_pg_pass $POSTGRES_PASSWORD $user_pg_pass"
...
if [ ! -f ./config.py ]; then
    ...
    echo "SQLALCHEMY_DATABASE_URI = \"postgresql://$user_pg:$user_pg_pass@$db_host:$db_port/$db_name\"" >> ./config.py
