...
* Ajout association entre les statuts et le référentiel_geographique `taxonomie.bdc_statut_cor_text_area`. L'association entre les textes et les statuts est réalisées lorsque le texte est associé à une région ou un département.
