...
-- Ajout des 8 taxons exemple aux listes nécéessaires à GeoNature
...
INSERT INTO cor_nom_liste (id_nom ,id_liste) VALUES ((SELECT id_nom FROM bib_noms WHERE nom_francais = 'Cicindèle hybride'), 1002);
INSERT INTO cor_nom_liste (id_nom ,id_liste) VALUES ((SELECT id_nom FROM bib_noms WHERE nom_francais = 'Coccinelle à 7 points'), 1002);
...
INSERT INTO cor_nom_liste (id_nom ,id_liste) VALUES ((SELECT id_nom FROM bib_noms WHERE nom_francais = 'Cicindèle hybride'), 9);
INSERT INTO cor_nom_liste (id_nom ,id_liste) VALUES ((SELECT id_nom FROM bib_noms WHERE nom_francais = 'Coccinelle à 7 points'),9);
