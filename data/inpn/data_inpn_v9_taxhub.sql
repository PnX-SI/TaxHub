...
FROM  '/path/to/app/data/inpn/TAXREFv90.txt'
WITH  CSV HEADER 
...
FROM  '/path/to/app/data/inpn/PROTECTION_ESPECES_TYPES_90.csv'
WITH  CSV HEADER 
...
FROM  '/path/to/app/data/inpn/PROTECTION_ESPECES_90.csv'
WITH  CSV HEADER 
DELIMITER ';'  encoding 'LATIN1';
