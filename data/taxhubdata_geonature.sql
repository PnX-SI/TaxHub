-- Données insérées pour GeoNature
...
-- Insertion du thème permettant de regrouper les attributs nécessaires au fonctionnement de GeoNature
INSERT INTO bib_themes (nom_theme, desc_theme, ordre, id_droit)
     VALUES ('GeoNature', 'Informations nécessaires au fonctionnement de GeoNature', 3, 4);
SELECT setval('taxonomie.bib_themes_id_theme_seq', (SELECT max(id_theme)+1 FROM taxonomie.bib_themes), true);

-- Insertion des 2 attributs nécessaires au fonctionnement de GeoNature
...
-- Insertion des listes de noms nécessaires au fonctionnement de GeoNature
