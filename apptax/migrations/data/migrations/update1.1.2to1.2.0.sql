...
UPDATE taxonomie.bib_listes SET picto = 'images/pictos/nopicto.gif' WHERE picto IS NULL;
...
CREATE TABLE IF NOT EXISTS taxonomie.taxref_protection_articles_structure
(
