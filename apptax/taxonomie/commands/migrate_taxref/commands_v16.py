...
@click.group(help="Migrate to TaxRef v16.")
def migrate_taxref_v16():
    pass


@migrate_taxref_v16.command()
@with_appcontext
def import_taxref_v16():
    """
...
def apply_changes(
    ...
    save_data(15, keep_oldtaxref, keep_oldbdc)
